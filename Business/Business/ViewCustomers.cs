...
{
    [Table("Customers")]
    public class ViewCustomers // : Customers // En attendant la version 7.0 qui gère les types immutables
    {
        public ViewCustomers() // Test #3
        {
        }
        ...
        public ViewCustomers(dynamic expando)
        {
